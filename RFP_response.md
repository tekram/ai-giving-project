...
* **Alignment Scoring:** Real-time AI calculation of how a specific nonprofit aligns with a donor's core values.
* **Agentic Giving:** Autonomous capital distribution using **Copilot** (approval-based) or **Autopilot** (fully automated) modes.
* **Transparency Engine:** Live ingestion of US IRS Form 990 data to provide instant financial health metrics and overhead audits.
...
**Indirect Cost Rate:** 0% (Full funding directed to project execution)

| Category | Description | Amount |
| :--- | :--- | :--- |
| **Personnel** | Dev Lead (Tashfeen Ekram) & Project Manager (Jawaid Ekram) | $50,000 |
| **Technical Architecture** | Firebase/Google Cloud Infrastructure & Database Management | $25,000 |
| **Field Pilot** | 12-month validation program with OBAT Helpers donor network | $40,000 |
| **AI & Data Acquisition** | Gemini 2.0 API credits & 990 Tax Data parsing costs | $30,000 |
| **Security & Audit** | Data privacy verification & SOC2 compliance audit | $5,000 |
| **Total** | | **$150,000** |
